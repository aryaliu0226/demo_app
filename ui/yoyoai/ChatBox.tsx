...
export default function ChatBox({
  ...
  return (
    <div className='sticky bottom-6'>
      <div className='max-w-2xl px-4 pb-4 pt-3 border border-border  rounded-xl bg-background px-4 py-2 shadow-[0_12px_40px_rgba(26,26,26,0.14)]'>
        ...
        <div className='w-full flex justify-end  gap-2 rounded-2xl '>
          <button
